...
class TreeRooting(BasePath):
    def __init__(self, fam_id, outgroup_id_arr, non_family_seq_count_cutoff):
        self.fam_id = fam_id
    ...
    def root_tree(self):
        ...
        if outgroup_monophyly_check[0]:
            ...
            arranged_outgroup_sequence_list = self.arrange_outgroup_sequence_ids(outgroup_sequence_list_from_seqlist)
    ...
    def arrange_outgroup_sequence_ids(self, outgroup_sequence_list):
